...
*/
  ...
  @Override public boolean onOptionsItemSelected(android.view.MenuItem item) {
    ...
    //  return true;
      ...
      return true;
    } else if (itemId == R.id.main_menu_quit) {
      //this.finishAffinity();
      finishAndRemoveTask();
      return true;
    }
          ...
          if (androidx.core.content.ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == android.content.pm.PackageManager.PERMISSION_GRANTED
           || androidx.core.content.ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) == android.content.pm.PackageManager.PERMISSION_GRANTED
            ...
            androidx.core.app.ActivityCompat.requestPermissions(this,
              ...
              -1 // this is a custom requestCode allowing the program to match this in the callback function
		    );
          }
        }
      } catch(SecurityException e) {
        writeMessage("CompassActivity.requestLocationUpdates:SecurityException", e.getMessage());
        return;
      } catch(Exception e) {
